	...
	cases := []struct {
		...
		},
		{
			Customer{
				"Bar",
				[]movies.Rental{
					movies.Rental{Movie: movies.NewMovie("The Thing", movies.NEW_RELEASE), DaysRented: 1},
				},
			},
		...
		},
		{
			Customer{
				"Baz",
				[]movies.Rental{
					movies.Rental{Movie: movies.NewMovie("Paddington 2", movies.CHILDRENS), DaysRented: 1},
					movies.Rental{Movie: movies.NewMovie("Frozen", movies.CHILDRENS), DaysRented: 30},
				},
			},
